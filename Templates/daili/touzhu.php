...
$list = touzhurenshu($user_ids, $day1 , $day2 , $_GET['p']>0?$_GET['p']:1 , 10);
$order_list = $list['list'];
$page = getPageList($list['count'] , 10 , '/Templates/daili/touzhu.php');
?>
<!DOCTYPE html>
...
<header class="m-navbar" style="">
    ...
    <div class="navbar-center">
        <span class="navbar-title" style="">投注人数</span>
    </div>
