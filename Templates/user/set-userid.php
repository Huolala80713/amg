        ...
        <div class="wx_cfb_account_center_wrap">
            <div class="wx_cfb_ac_fund_detail">
                <div class="user_info clearfix">
                    ...
                    <div class="titlexb">修改昵称</div>
                </div>
            </div>
                <!--入口-->
            <div class="wx_cfb_entry_list">
                <div class="blockrow">
                    <li class="lefttitle">新用户名</li>
                    <li class="inputbox"><input placeholder="新用户名" type="text" id="username"></li>
                </div>
                <div class="blockrow subbt">
                    <li class="sub" onclick="subuserid()">提交</li>
                </div>
            </div>
        </div>
    </div>
