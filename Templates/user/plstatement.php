...
<div  style="overflow-y: auto;">
    <ul  class="listul">
        ...
        <li  style="background: rgba(195, 197, 194, 0.33); border-right: 0px solid rgb(208, 208, 208); color: red; height: 50px; line-height: 40px;"></li>
        <li onclick="location.href='/Templates/user/orderinfo.php?back=1&day1=' + $('#day1').val() + '&day2=' + $('#day2').val() + '&type=<?php echo $type;?>&game_name=<?php echo $key;?>'"><span style="text-decoration: underline;"><?php echo (isset($info['game'][$key]['touzhu']) && $info['game'][$key]['touzhu']) ? $info['game'][$key]['touzhu'] : 0;?></span>投注金额</li>
        <li onclick="location.href='/Templates/user/orderinfo.php?back=1&day1=' + $('#day1').val() + '&day2=' + $('#day2').val() + '&type=<?php echo $type;?>&game_name=<?php echo $key;?>&log_type=zj'"><span style="text-decoration: underline;"><?php echo (isset($info['game'][$key]['zhongjian']) && $info['game'][$key]['zhongjian']) ? $info['game'][$key]['zhongjian'] : 0;?></span>中奖金额</li>
        <li onclick="location.href='/Templates/user/marklog.php?back=1&day1=' + $('#day1').val() + '&day2=' + $('#day2').val() + '&type=<?php echo $type;?>&log_type=fandian&game_name=<?php echo $key;?>'"><span  style="text-decoration: underline;"><?php echo (isset($info['game'][$key]['fandian']) && $info['game'][$key]['fandian']) ? $info['game'][$key]['fandian'] : 0;?></span>返点金额
        <?php endforeach;?>
    </ul>
</div>
