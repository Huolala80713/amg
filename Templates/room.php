...
<head>
    ...
    <link rel="Stylesheet" type="text/css" href="/Style/newcss/chatroom.css?t=17" />
...
<!--text-align: left;-->
<!--width: 0px;-->
<!--font-size: 13px;"><a style="color: gold;text-decoration:none;font-size: 13px;" href="/caiji/168kj/dating.html"> <img src="/SwitchTable2.png" style="left:0px; position: relative; top:0px" /></div></a>-->
...
<div class="mainbox max-width">
    ...
    <div id="keyboard-panel" style="position: fixed;bottom: 0px;left: 0px;width: 100%;z-index: 10000;">
        ...
        <div style="display: none" id="keyboard2" class="keybaord">
            <div class="fast-keyboard-url">
                <li data-txt="充值指引" data-url="/Templates/user/codepay/index.php"><p><img src="/Style/newimg/sxf.png"></p><p>充值指引</p></li>
...
<script type="text/javascript">
    ...
    function showOpenInfo(row) {
        <?php if($game_id == 6):?>
        $('#next_sn').html(row.next_sn.slice(4));
        $('#current_sn').html(row.current_sn.slice(4));
        <?php else:?>
        $('#next_sn').html(row.next_sn.slice(3));
        $('#current_sn').html(row.current_sn.slice(3));
        <?php endif;?>
