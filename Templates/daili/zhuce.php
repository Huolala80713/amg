...
$list = zhuchelist($user_ids, $day1 , $day2 , $_GET['p']>0?$_GET['p']:1 , 10);
$user_list = $list['list'];
$page = getPageList($list['count'] , 10 , '/Templates/daili/zhuce.php');
?>
<!DOCTYPE html>
...
<header class="m-navbar" style="">
    ...
    <div class="navbar-center">
        <span class="navbar-title" style="">注册列表</span>
    </div>
    ...
    <table class="total-table" style="font-size: 0.3rem;">
        ...
        if(!empty($user_list)):
            ...
            <tr>
                ...
                <td><?php echo date('y-m-d' ,strtotime($user['aztime'])) . '<br>' . date('H:i:s' , strtotime($user['aztime']));?></td>
            </tr>
            <?php }?>
        <?php endif;?>
        </tbody>
