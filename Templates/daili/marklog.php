...
$list = user_log_list($user_ids, $day1 , $day2 , $log_type , $game_name, $_GET['p']>0?$_GET['p']:1 , 10);
$log_list = $list['list'];
$page = getPageList($list['count'] , 10 , '/Templates/daili/marklog.php');
...
<header class="m-navbar" style="">
    ...
    <div class="navbar-center">
        <span class="navbar-title" style="">交易明细</span>
    </div>
...
<div class="m-cell" style="margin-top:0.35rem;">
    <div class="cell-item redio_panel">
        ...
        <div class="cell-right">
            <div id="log_typelist" style="position: absolute;right: 10px;top: 0;min-height: 1.0rem;align-items: center;-webkit-box-align: center;display: flex;">
                <em><?php
                    switch ($log_type){
                        case 'recharge':
                            echo '上分';
    ...
    <div class="cell-item">
        ...
        <div class="cell-right"><input type="text" class="cell-input" id="day1" value="<?php echo $day1?$day1:date('Y-m-d');?>" disabled="disabled"></div>
    </div>
    <div class="cell-item">
        <div class="cell-left">结束时间：</div>
        <div class="cell-right"><input type="text" id="day2" class="cell-input" value="<?php echo $day2?$day2:date('Y-m-d');?>" disabled="disabled"></div>
    </div>
</div>
        ...
        <?php if (count($log_list)):?>
            <?php foreach ($log_list as $item){?>
                <tr>
                    ...
                    <?php if($log_type == 'fandian'):?>
                    <td><?php echo getGameTxtNameByCode($item['game']);?></td>
                    <?php endif;?>
                </tr>
            <?php }?>
        <?php else:?>
...
<div id="typeBox" class="_problemBox" style="">
    <div class="blackBg"></div>
    <div class="moreLayer">
        <ul>
            ...
            <li onclick="changetype('paijiang')">
                <a>派奖</a>
            </li>
            <li onclick="changetype('touzhu')">
                <a>投注</a>
            </li>
            <li onclick="changetype('chedan')">
                <a>撤单退还</a>
            </li>
            <li onclick="changetype('fandian')">
                <a>返点</a>
            </li>
            <li onclick="changetype('huodong')">
                <a>活动</a>
            </li>
            <li onclick="changetype('huishui')">
                <a>回水</a>
            </li>
        </ul>
        <ul>
...
<script type="text/javascript">
    ...
    function search(type){
        ...
        window.location.href="?day1="+day1+"&day2="+day2+"&type="+type+"&log_type=" + log_type + "&game_name=" + game_name + "&back=<?php echo $back;?>&userid=<?php $_GET['userid'];?>";
    }
