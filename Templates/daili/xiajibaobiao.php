...
$type = $_GET['type'];
$list = xiajibaobiao($user_id , $day1 , $day2 , $_GET['p']>0?$_GET['p']:1 , 10);
$user_list = $list['list'];
$page = getPageList($list['count'] , 10 , '/Templates/daili/xiajibaobiao.php');
?>
<!DOCTYPE html>
...
<header class="m-navbar" style="">
    ...
    <div class="navbar-center">
        <span class="navbar-title" style="">下级报表</span>
    </div>
...
<div class="total-log" style="padding: 0;">
    <table class="total-table" style="font-size: 0.3rem;">
        ...
        if(!empty($user_list)):
            ...
            <tr onclick="searchuser('<?php echo $user['userid'];?>')">
                <td><span style="text-decoration: underline;color: red;"><?php echo $user['userid'];?></span></td>
                <td><?php echo $user['child_user_count'];?></td>
                <td><?php echo $user['touzhu'];?></td>
                <td><?php echo $user['paijiang'];?></td>
                <td><?php echo $user['yk'];?></td>
            </tr>
            <?php }?>
        <?php endif;?>
        </tbody>
...
<script type="text/javascript">
    ...
    $('.sub').on('click' , function (){
        search('<?php echo $type;?>' , '<?php echo $user_id;?>');
    });
    function search(type , userid){
        var day1 = $("#day1").val();
        var day2 = $("#day2").val();
        ...
        window.location.href="?day1="+day1+"&day2="+day2+"&type="+type+"&userid=" + userid;
    }
    function searchuser(userid){
        search('<?php echo $type;?>' , userid);
    }
    function chagedate(type,dom , day1,day2){
        $("#day1").val(day1);
        $("#day2").val(day2);
        search(type , '<?php echo $user_id;?>');
    }
</script>
</body>
</html>