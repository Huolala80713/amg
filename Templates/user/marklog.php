...
$list = user_log_list($user_id, $day1 , $day2 , $log_type , $game_name, $_GET['p']>0?$_GET['p']:1 , 10);
$log_list = $list['list'];
$page = getPageList($list['count'] , 10 , '/Templates/user/marklog.php');
...
<header class="m-navbar" style="">
    ...
    <div class="navbar-center">
        <span class="navbar-title" style="">资金记录</span>
    </div>
...
<script type="text/javascript">
    ...
    function search(type){
        ...
        window.location.href="?day1="+day1+"&day2="+day2+"&type="+type+"&log_type=" + log_type + "&game_name=" + game_name;
    }
