...
switch($time){
case 1: $time = date('Y-m-d') . ' 06:00:00 - ' . date('Y-m-d' , strtotime('+1day')) . ' 05:59:59';
    break;
case 7: $time = date('Y-m-d', strtotime('-7 day')) . ' 06:00:00 - ' . date('Y-m-d' , strtotime('+1day')) . ' 05:59:59';
    break;
case 30: $time = date('Y-m-d', strtotime('-30 day')) . ' 06:00:00 - ' . date('Y-m-d' , strtotime('+1day')) . ' 05:59:59';
    break;
}
