...
<!--text-align: left;-->
<!--width: 0px;-->
<!--font-size: 13px;" onclick="show()"><a style="color: gold;text-decoration:none;font-size: 13px;" href="#"><img src="/GameMenu3.1.png" style="left:0px; position: relative; top:90px" /></a></div> -->
<!--    <div id="div" style="-->
<!--    display: none;-->
<!--    position: absolute;-->
<!--    margin: -20px 0px -115px -14px;-->
<!--    z-index: 10000;">-->
<!--                <iframe src="https://kj.1680210.com/view/video/jisuft_video/index.html?10057?1682018.co" width="10%" height="20%" style="width: 430px; height: 280px;"></iframe>-->
<!--            </div>-->
...
<!--text-align: left;-->
<!--width: 0px;-->
<!--font-size: 13px;"><a style="color: gold;text-decoration:none;font-size: 13px;" href="/caiji/168kj/xyft.html"> <img src="/SwitchTable2.png" style="left:0px; position: relative; top:0px" /></div></a>
-->
...
<script type="text/javascript">
    ...
    $('#msg').on('click',function () {
        ...
        //     if($('#keyboard1').is(":hidden") && $('#keyboard2').is(":hidden")){
        //         showKeyBord=true;
